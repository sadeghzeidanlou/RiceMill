...
namespace RiceMill.Application.Common.Models.ResultObject
{
    public sealed class Result<T>
    {
        ...
        public static Result<T> Forbidden() => new() { Errors = new List<Error> { Error.CreateError(ResultStatusEnum.Forbidden) }, HttpStatusCode = HttpStatusCode.Forbidden };

        public static Result<T> NotImplemented() => new() { Errors = new List<Error> { Error.CreateError(ResultStatusEnum.NotImplemented) }, HttpStatusCode = HttpStatusCode.NotImplemented };
