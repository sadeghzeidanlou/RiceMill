...
{
    public sealed record DtoCreateUser(string Username, string Password, RoleEnum Role, Guid? UserPersonId, Guid? RiceMillId);

    public sealed class DtoCreateUserValidator : AbstractValidator<DtoCreateUser>
    {
