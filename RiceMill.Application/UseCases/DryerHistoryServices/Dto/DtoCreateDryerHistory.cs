...
{
    public sealed record DtoCreateDryerHistory(DryerOperationEnum Operation, DateTime StartTime, DateTime? EndTime, Guid DryerId, Guid InputLoadId, short NumberOfBagsInDryer, Guid? RiceMillId);
