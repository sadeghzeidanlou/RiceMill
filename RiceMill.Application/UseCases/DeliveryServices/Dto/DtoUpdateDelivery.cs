...
{
    public sealed record DtoUpdateDelivery(Guid Id, DateTime DeliveryTime, float UnbrokenRice, float BrokenRice, float ChickenRice, float Flour, string Description, Guid DelivererPersonId, Guid ReceiverPersonId, Guid CarrierPersonId, Guid VehicleId, Guid RiceThreshingId);
